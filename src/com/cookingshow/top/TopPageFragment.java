...
public class TopPageFragment extends CommonFragment implements
    ...
    private View getChildView(LayoutInflater inflater, int index) {
        AdItemLayout child = (AdItemLayout) inflater.inflate(R.layout.top_ad_item, null);
    ...
    private void setAdOrderValue(AdItemLayout adLayout, int pos) {
        String num = "";
        int bgId = -1;
        if (mPageInfo.mPageNum == 0) {
            switch (pos) {
                case 0:
                    num = "";
                    bgId = R.drawable.top_icon_1;
                    break;
                case 1:
                    num = "";
                    bgId = R.drawable.top_icon_2;
                    break;
                case 2:
                    num = "";
                    bgId = R.drawable.top_icon_3;
                    break;
                default:
                    num = String.valueOf(pos + 1);
                    bgId = R.drawable.top_num_icon;
                    break;
            }
        } else {
            bgId = R.drawable.top_num_icon;
            num = String.valueOf(mPageInfo.mPageNum * ITEMS_PER_PAGE + pos + 1);
        }
        adLayout.setAdOderBg(bgId);
        if (!TextUtils.isEmpty(num)) {
            adLayout.setAdOrderText(num);
        }
    }
