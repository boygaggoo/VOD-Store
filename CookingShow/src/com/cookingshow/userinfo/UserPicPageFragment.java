...
public class UserPicPageFragment extends CommonFragment implements
    ...
    private void getAppInfoData() {
       ...
       /* mAllCount = 20;
        ...
        if(mStartIndex == 0) {
            ...
            data2.setTitle("tttt2");
            //data2.setVersion("3");
            mAppData.add(data2);
            
            DishDataInfo data3 = new DishDataInfo();
            data3.setTitle("tttt3");
            //data3.setVersion("3");
            mAppData.add(data3);
            ...
            data7.setTitle("tttt7");
            //data7.setVersion("3");
            mAppData.add(data7);
            
            DishDataInfo data8 = new DishDataInfo();
            data8.setTitle("tttt8");
            //data8.setVersion("3");
            mAppData.add(data8);
            
            DishDataInfo data9 = new DishDataInfo();
            data9.setTitle("tttt9");
            //data9.setVersion("3");
            mAppData.add(data9);        	
        }
        else if(mStartIndex == 9){
        	DishDataInfo data10 = new DishDataInfo();
            data10.setTitle("ttt10");
            //data10.setVersion("3");
            mAppData.add(data10);
            
            DishDataInfo data11 = new DishDataInfo();
            data11.setTitle("tttt11");
            //data11.setVersion("3");
            mAppData.add(data11);
            
            DishDataInfo data12 = new DishDataInfo();
            data12.setTitle("tttt12");
            //data12.setVersion("3");
            mAppData.add(data12);
            
            DishDataInfo data13 = new DishDataInfo();
            data13.setTitle("ttt13");
            //data13.setVersion("5");
            mAppData.add(data13);
            
            DishDataInfo data14 = new DishDataInfo();
            data14.setTitle("tttt14");
            //data14.setVersion("3");
            mAppData.add(data14);
            
            DishDataInfo data15 = new DishDataInfo();
            data15.setTitle("ttt15");
            //data15.setVersion("3");
            mAppData.add(data15);
            
            DishDataInfo data16 = new DishDataInfo();
            data16.setTitle("tttt16");
            //data16.setVersion("3");
            mAppData.add(data16);
            
            DishDataInfo data17 = new DishDataInfo();
            data17.setTitle("tttt17");
            //data17.setVersion("3");
            mAppData.add(data17);
            
            DishDataInfo data18 = new DishDataInfo();
            data18.setTitle("tttt18");
            //data18.setVersion("3");
            mAppData.add(data18);          	
        }
        else {
        	DishDataInfo data19 = new DishDataInfo();
            data19.setTitle("tttt19");
            //data19.setVersion("3");
            mAppData.add(data19);
            
            DishDataInfo data20 = new DishDataInfo();
            data20.setTitle("tttt20");
            //data20.setVersion("3");
            mAppData.add(data20);        	
        }
        */
