...
public class UserDiningPageFragment extends CommonFragment implements 
        AppGridLayout.ItemOnBoundaryListener {

    private static final String TAG = "UserDiningPageFragment";
    ...
    public boolean focusOnBoundaryBottom() {
    	Log.i(TAG, "focusOnBoundaryBottom");
        if (mPageNotifyListener != null) {
            mPageNotifyListener.onFocusToBottom();
            return true;
        }
        return false;
    }
        ...
        public void onClick(View v) {
            if (v.getTag() != null) {
                ...
                if (mAppData != null && clickPos < mAppData.size()) {
                	if(mAdapter.getViewForChoice(clickPos) == View.GONE) {
                		mAdapter.setViewForChoice(clickPos);
                	}
                	else {
                		mAdapter.resetViewForChoice(clickPos);
                	}
